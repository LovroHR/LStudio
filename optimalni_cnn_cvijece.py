"""
Optimalniji CNN za 5. laboratorijsku vježbu - klasifikacija cvijeća
...
Pokretanje:
python optimalni_cnn_cvijece.py
...
# Pola validation skupa koristimo kao testni skup
...
# Augmentacija slika - smanjuje overfitting i pomaže boljem accuracyju
...
model = models.Sequential([
    ...
    # Umjesto Flatten koristimo GlobalAveragePooling2D:
    # manje parametara, brže treniranje i često bolja generalizacija
...
print("Najbolji model spremljen kao: najbolji_cvijece_model.keras")
